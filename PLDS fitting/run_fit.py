...
# path
path_get = 'data/' #/Users/carolinehaimerl/Google Drive/1 Science/NYU/PhD_projects/modulation in V1-MT/Ruff_Cohen/data_files/datafiles_matTOpy/'
path_save = '/Users/carolinehaimerl/Google Drive/1 Science/papers/data paper/NatureComm/final/code/PLDS fitting/results_tmp/'
